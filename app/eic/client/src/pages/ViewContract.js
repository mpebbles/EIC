      ...
      <div>
        {this.state.doneLoading && (
          <div>
            ...
            <div>Pay: {this.state.contract.pay}</div>
            <div>Location: {this.state.contract.location}</div>
            <div>Created by: {this.state.contract.creation_date}</div>
            <div>Created on: {this.state.contract.creator}</div>
            <div>{this.state.contract.description}</div>
          </div>
        )}
      </div>
    );
