...
router.get(
  "/add_pending_buddy/:buddy_email",
  student_controller.add_pending_buddy
);

router.get(
  "/add_pending_student/:student_email",
  buddy_controller.add_pending_student
);
...
router.get(
  "/reject_pending_student/:student_email",
  buddy_controller.reject_pending_student
);

router.get(
  "/reject_pending_buddy/:buddy_email",
  student_controller.reject_pending_buddy
);

router.get(
  "/accept_pending_student/:student_email",
  buddy_controller.accept_pending_student
);

router.get(
  "/accept_pending_buddy/:buddy_email",
  student_controller.accept_pending_buddy
);
...
router.post(
  ...
  user_controller.addUserProfileImage
);
